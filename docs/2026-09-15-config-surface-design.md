...
| **★ `docs/2026-09-15-consult-delivery-design.md`** | **D14-12**：**用户裁定③的落点**——把**批 15** 的 **AC-5 / AC-25 层标由 T1 降为 T3**（它们只有提示词承载、零机制）；**同批改其 §11.2 分层表与 §11.3 的两行**（**不许只改一处**——否则重演「同文档两处枚举不同步」） | 修改（**跨批**） |
