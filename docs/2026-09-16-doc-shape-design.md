...
### §5.0 图 1：谓词总览与**四道闸**（**★ 评审 #9 订正：本批是「四条腿」，不是「五道闸/腿 1–5」——腿 4 内含两道闸，见 §5.4**）
...
- **AC 号不重复**；
- **★ 反向（孤儿锚，评审 #5 补入）**：**锚表里每个锚至少被一条 AC 引用**；**未引用的锚必须自带显式豁免标记**（写法见 §10.3 的 A10 一行）——**初版只做了正向，而 A10 自己就是唯一未被引用的锚**。
