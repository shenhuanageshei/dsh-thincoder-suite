...
export function mergeGlobalConfig(baseConfig, userCfg) {
  ...
  // codexCli（一期 codex-runner，docs/2026-09-03-codex-runner-research.md §5.2）：字段级白名单合并
  if (user.codexCli && typeof user.codexCli === "object" && !Array.isArray(user.codexCli)) {
    const CODEXCLI_FIELDS = ["executable", "proxyMode", "proxyUrl", "agentsMdPolicy", "model", "defaultTimeoutMs", "idleTimeoutMs", "engCoderRunner", "budgetCapMs"]
