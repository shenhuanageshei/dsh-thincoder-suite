      ...
      parameters: {
        ...
        properties: {
          ...
          stages: {
            type: "array",
            maxItems: 10,
            description: "Structured execution stages (2-8 recommended, max 10). Stage N's check must pass before N+1; a stage failing twice stops the run. On the dsh path checks default to host-executed (checkMode: the host runs them after delivery and appends the receipt).",
            items: {
              type: "object",
              properties: {
