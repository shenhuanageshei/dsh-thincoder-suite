...
function readRegisteredToolNameSurface(ctx) {
  ...
  if (viaView !== undefined) return { names: viaView.length > 0 ? viaView : null, source: "view.restrictableNames" }
...
export function resolveExecToolDeny(ctx, baseDeny) {
  ...
  if (!surface.names) return { deny: base, applied: false, execNames: [], source: surface.source, reason: "取不到平台工具名清单（注册表读取面不可用）" }
